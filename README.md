...
## 🗞️ 新增补充条目（2026-05-14·第四次更新）

### MIT/芝加哥/东京/港中大 × PRX Quantum — 纠缠增强多参数量子估计，金刚石NV中心实现单次测量同步估计三个微波场参数（2026-05）
- [利用固态量子传感器实现纠缠增强的多参数估计（PRX Quantum, 2026-05）](https://journals.aps.org/prxquantum/abstract/10.1103/kqfr-bbfx) | [MIT News, 2026-04-15](https://news.mit.edu/2026/multitasking-quantum-sensors-can-measure-several-properties-0415)
- **技术**：基于金刚石氮-空位（NV）中心的电子-核自旋纠缠体系，配合优化的贝尔态测量方案，在单次测量序列中同步估计微波驱动场的幅值、失谐量与相位
- **核心突破**：实际约束条件下，所有参数灵敏度仍随探测时间呈线性标度——弥合了量子估计理论与实用化固态量子传感之间的鸿沟
- **意义**：为适用于多学科科技应用的高性能多参数量子传感器开辟路径；量子多参数估计从理论走向现实，NV中心量子传感平台向多物理场同步精密测量迈进

### Quantinuum向SEC提交S-1，IPO股票代码"QNT"，估值有望冲击200亿美元（2026-05-08）
- [百年工业巨头霍尼韦尔控股Quantinuum正式提交S-1（搜狐, 2026-05-09）](https://so.html5.qq.com/page/real/search_news?docid=70000021_12869ff1d4748152) — 拟在纳斯达克全球精选市场挂牌上市
- **量子传感关联**：Quantinuum基于离子阱技术，其H1/H2/Helios系统同时支撑量子传感（量子陀螺仪、量子惯性导航）研发；离子阱量子比特天然具备高保真度、长相干时间，是量子精密测量的核心硬件平台
- **财务数据**：2025年估值100亿美元；分析师预计IPO估值有望冲击200亿美元，成为量子计算领域有史以来规模最大的首次公开募股
- **战略意义**：霍尼韦尔"全方位投资组合转型"核心环节，量子资产资本化路径正式启动；量子传感与量子计算协同发展格局进一步明确

### Monarch Quantum × Oratomic — 光子引擎+中性原子qLDPC纠错，仅用1万比特实现容错量子计算（2026-04-28）
- [光和原子联手，量子要量产了（搜狐, 2026-04-29）](https://so.html5.qq.com/page/real/search_news?docid=70000021_95769f1e58162352) — 战略合作伙伴关系正式达成
- **技术整合**：Monarch Quantum提供"量子光引擎"（QLE）——将数百个分立光学元件集成至紧凑工厂对准模块，替代需要12-18个月手动搭建的传统光路；Oratomic提供中性原子量子硬件
- **核心突破**：Oratomic证明实用级容错量子计算所需物理比特数量从100万缩减至约1万（qLDPC低密度奇偶检查码，lp24方案，编码率30%）
- **量子传感应用**：NASA选择Monarch为其"量子重力梯度仪开拓者（QGGPf）"任务提供光子引擎——2030年发射的卫星任务，要求量子系统在太空严苛环境中保持极高精度和稳定性
- **意义**：量子计算从"实验室作坊"向"工业化量产"转变；量子重力传感与集成光子技术协同加速，量子传感天地一体化进程推进

### Quantum Motion（英国）— 完成1.6亿美元C轮融资，押注硅基量子计算"晶体管时刻"（2026-05-07）
- [英国Quantum Motion融资1.6亿美元（搜狐, 2026-05-07）](https://so.html5.qq.com/page/real/search_news?docid=70000021_18369fc878c29252) — 创下英国量子公司最大单笔VC融资纪录
- **技术**：采用标准硅晶体管制造量子比特——所用技术与智能手机、电脑芯片相同，借助CMOS工艺实现可扩展量子计算机制造
- **量子传感关联**：硅基量子点量子比特与NV色心同属固态量子传感体系；量子Motion的技术积累可反向促进固态量子传感器规模化制造
- **融资用途**：扩展研发团队与工程化能力，加速硅基量子处理器商业化路径

---

*本次更新: PRX Quantum纠缠增强多参数NV估计 / Quantinuum S-1 IPO提交 / Monarch×Oratomic光子+中性原子量子计算 / Quantum Motion 1.6亿美元融资（2026-05-14晚）*
