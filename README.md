...
*本次更新: 深圳大学纠缠增强量子精密测量 / 河南工业大学EP辅助量子传感 / 南加州大学Nature Comm 165%灵敏度提升NRAM / 薛鹏团队非厄米临界增强PRL / USTC NV色心1.7nm定位 / + MIT量子雷达/Qnami商业产品线/Sandia原子干涉仪专利(远程合并更新)*

---

### 🆕 新增条目(2026-05-19上午 - 第五批)

#### 深圳大学量子精密测量研究所 - 纠缠增强量子精密测量系统综述,冷原子/囚禁离子体系多参数量子传感(2026-05-18)
- [深圳大学量子精密测量研究所](https://quantum.szu.edu.cn/info/1090/1427.htm) | 李霍朋(Chaohong Lee)团队,2026-05-18发布
- **研究方向**:基于冷原子、囚禁离子等多体量子体系,研究非高斯纠缠态量子精密测量基本原理,发展纠缠增强量子传感新方案
- **核心成果**:
  - 跨越量子相变的多体量子干涉精密测量方案
  - 原子自旋猫态实现鲁棒的量子相位估计方案
  - 自发对称破缺体系中绝热演化制备多粒子纠缠态
  - 量子混沌提高参数测量精度方案
  - GHZ态实现海森堡极限原子Sagnac干涉方案
  - 多体量子锁相放大器,同时测量磁场振幅和频率
  - 纠缠增强射频磁场直流/交流分量同时测量方案
  - 基于纠缠原子系综的洛伦兹不变性破缺验证方案
- **代表论文**:Huang et al., Entanglement-enhanced quantum metrology (Applied Physics Reviews 2024); Lee, Adiabatic Mach-Zehnder Interferometry (PRL 2006); Zhuang et al., Heisenberg-Limited Frequency Estimation (PRApplied 2021)等
- **意义**:深圳大学量子精密测量研究所是国内量子传感与量子精密测量领域的重要研究力量,纠缠增强路线为实用化量子传感提供清晰技术路径

#### 河南工业大学量子材料与量子传感实验室 - 高阶EP辅助PT对称光机械量子传感,超灵敏力学测量新方案(2026-05-19)
- [河南工业大学量子材料与量子传感实验室](http://mimlab.zzuli.edu.cn/dtcljgycddk/list.htm) | 2026-05-19更新
- **研究目标**:建立人工量子材料的绿色高效制备方法,探索量子结构与性能构效关系,实现量子态工程精准调控量子相干性与消相干性
- **量子传感方向**:
  - 提出PT对称和反对称光机械杂化量子系统中高阶EP(Exceptional Point, 非厄米奇异点)辅助超灵敏测量方案
  - 揭示高阶EP对测量灵敏度的增强机制
  - 研究量子噪声对PT光机械传感的影响,探索EP辅助量子噪声抑制方案
  - 目标实现接近或突破标准量子极限的超灵敏力学传感技术
- **技术路径**:通过引入可控损耗构建非厄米哈密顿量,利用EP临界点附近量子Fisher信息的指数增长实现灵敏度增强
- **意义**:非厄米量子传感是当前量子精密测量前沿热点,高阶EP增强方案为片上集成量子传感提供了新的工程化思路

#### 南加州大学 × Quantum Elements - Nature Communications:确定性量子比特控制突破Ramsey极限,灵敏度提升165%(2026-04)
- [Nature Communications论文:Beating the Ramsey limit on sensing with deterministic qubit control](https://news.qq.com/rain/a/20250430A08NXU00) | M. O. Hecht第一作者,Eli M. Levenson-Falk通讯作者,2026-04发表于Nature Communications
- **技术**:针对退相干环境中量子比特频率测量的灵敏度瓶颈,提出确定性量子比特控制协议,利用连续驱动稳定布洛赫矢量分量
- **突破**:超导量子比特实验展示,相较标准Ramsey方法——每次测量灵敏度提升1.65倍,每次量子比特演化时间灵敏度提升1.09倍;理论分析最大增强分别可达1.96×和1.18×
- **优势**:无条件增强,不依赖特定噪声条件;为量子传感在有噪声环境下的稳定灵敏度提升提供了新范式
- **意义**:量子传感退相干抑制技术从"概率性"向"确定性"演进,是量子传感实用化的重要里程碑

#### 北京计算科学研究中心薛鹏团队 - 非厄米量子行走临界增强量子传感,经典Fisher信息指数增长2.116/2.707(PRL, 2026-03)
- [量子精密测量领域获重要进展(搜狐, 2026-03-03)](https://so.html5.qq.com/page/real/search_news?docid=70000021_59469a6786249652) | 薛鹏教授团队联合东南大学、电子科技大学、安徽大学
- **技术**:首次在非幺正(non-unitary)光量子行走实验平台上观测到临界点增强的量子传感效应;通过引入可控光子损耗构建一维非厄米哈密顿量,观测"点能隙"与"线能隙"闭合临界现象
- **突破**:临界点附近经典Fisher信息随系统尺寸增长指数分别达2.116和2.707,远高于非临界状态,证实量子临界性对传感精度的超强提升
- **意义**:另辟蹊径规避稳态制备瓶颈;非厄米量子传感从理论走向实验验证,为下一代高灵敏度传感提供全新物理机制

#### USTC杜江峰/王亚团队 - 信号关联新量子传感范式:NV色心系综实现1.7nm定位精度/0.01ppb缺陷探测极限(Nature Photonics)
- [中科大在量子精密测量领域获重要进展(搜狐, 2024-01)](https://www.sohu.com/a/749994597_348129) | 国际学术期刊《自然·光子学》(Nature Photonics)发表
- **技术**:提出基于信号关联的新量子传感范式——可控制备相距约200纳米的三个氮-空位(NV)色心作为量子传感系统,利用类似卫星定位的量子定位技术
- **突破**:对微米范围内16个点缺陷实现精确定位,定位精度最高达1.7纳米;实现每个点缺陷电荷动力学的原位实时探测
- **探测极限**:对0.01ppb级别缺陷浓度(一千亿个正常原子中出现一个缺陷)进行探测,比目前最灵敏方法提升两个量级以上
- **意义**:为10纳米以下芯片缺陷检测提供强有力的技术手段,量子传感首次实现对"不可操控"量子体系的高精度探测
...
### 🆕 新增条目(2026-05-19上午 - 第六批)

#### QDTI - Quantum Diamond Technologies Inc.:哈佛系量子传感生物标志物检测,≤5µL样本/<1pg/mL灵敏度/<1小时手持时间(2026)
- [QDTI官网](https://www.qdti.com/) | 基于哈佛大学世界领先研究成果
- **技术核心**:利用金刚石晶体中工程化的氮空位(NV)中心作为量子传感引擎,开发新型生物分子检测方法
- **核心参数**:≤5 µL样本量;<1 pg/mL灵敏度;<1小时手持时间;仅需5步样本制备
- **产品定位**:量子传感+生物标志物检测,面向生物医学研究、药物研发、体外诊断市场
- **学术基础**:量子传感生物医学应用,利用NV中心对磁场/温度的超高灵敏度检测生物分子相互作用
- **意义**:量子传感首次系统性进入体外诊断(IVD)赛道,NV量子传感从物理实验室向生物医学工程延伸,商业化路径清晰

#### Q-CTRL × IBM实现全球首个"实用量子优势":量子传感误差抑制技术反向渗透量子计算(2026-05-06)
- [3000倍提速,Q-CTRL联手IBM打响「实用量子优势」第一枪(新浪, 2026-05-08)](https://k.sina.com.cn/article_5953189932_162d6782c0670489v8.html?cre=tianyi&mod=pcpager_news&loc=19&r=0&rfunc=79&tj=cxvertical_pc_pager_news&tr=174) | [Q-CTRL官网, 2026-05-13](https://q-ctrl.com/)
- **突破**:2026年5月6日,Q-CTRL与IBM宣布在IBM量子硬件上运行真实材料发现算法,实现3000倍绝对加速——量子运行仅需2分钟,同等问题经典高性能计算机需超过100小时
- **技术核心**:Q-CTRL的AI驱动量子误差抑制软件Fire Opal,将量子硬件与自主校准结合,突破噪声壁垒实现稳定运行
- **量子传感关联**:Q-CTRL同样将误差抑制技术应用于量子传感(量子导航/惯性传感器),量子计算与量子传感共享底层误差抑制能力
- **意义**:量子传感公司的误差抑制软件首次反向渗透量子计算,"量子传感+量子计算"协同路径打通;误差抑制是量子传感从实验室走向严苛工业环境的关键使能技术

#### Quantum Design完成收购牛津仪器纳米科学部门,低温量子技术服务体系整合(2026-01-02/01-18)
- [Quantum Design宣布完成收购牛津仪器纳米科学部门(腾讯, 2026-01-18)](https://so.html5.qq.com/page/real/search_news?docid=70000021_767696836eb31352) | 原文公告
- **交易时间**:2026年1月2日宣布完成收购,Oxford Instruments NanoScience部门正式并入Quantum Design
- **战略意义**:实现两家低温技术先驱企业的战略联合,标志着一个拥有超百年创新积淀的低温物理、材料科学及显微技术服务体系的诞生
- **Quantum Design量子传感布局**:Quantum Design中国是Qnami东亚代理(日本、韩国)、低温光学平台OptiCool(±7T/1.7K-350K)供应商,同时代理多种量子材料表征仪器
- **Oxford Instruments NanoScience**:长期为量子计算/传感提供稀释制冷机(如Proteox),曾与Quantum Motion、SEEQC、OQC等量子计算公司合作
- **关联**:低温技术是超导量子干涉仪(SQUID)、NV色心低温扫描显微镜、离子阱量子计算等量子传感/计算路线的核心使能技术;此次收购强化了Quantum Design在量子技术低温生态的垄断地位

#### 日本QST含金刚石量子传感器细胞温度测量:2030年前商业化,年产6-10万人份检测规模(2025-08)
- [日本经济新闻, 2025-08-21](https://so.html5.qq.com/page/real/search_news?docid=70000021_56368a7025921152) | 日本量子科学技术研究开发机构(QST),五十岚龙治团队
- **技术原理**:含微量氮的金刚石量子传感器——氮附近特殊晶格结构的电子状态受环境变化影响;受绿光照射发出红荧光,荧光强度波动反映温度变化
- **进展**:成功实现对细胞温度变化的高精度测量;QST计划2028年建成量产体系,年产满足6-10万人检测需求的传感器规模
- **目标**:2030年前通过企业合作实现商业化应用
- **意义**:量子传感直接进入高精度细胞生物学和疾病探查场景,日本国家队的产业化和商业化路径规划清晰
