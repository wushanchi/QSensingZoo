...
- **技术方案**:标准量子信息度量(并发度、负性、纠缠熵、CHSH边界、量子Fisher信息)在自旋0→far{f}衰变中对所有CP角都是纠缠态;但固定在自旋分析物理Pauli框架中的稳定器量子魔法可以检测这些CP相位
...
#### 上海交大量子感知与信息处理研究所:弱值测量/噪声抑制/高阶模多参量传感,灵敏度10⁻²⁴秒量级(2026-05)
- [上海交大量子感知与信息处理研究所](https://qsip.sjtu.edu.cn/info/1116/1328.htm) | 研究方向与成果
- **基础研究**:围绕量子传感核心机理与关键技术开展研究,提出基于反馈控制的弱值测量技术方案(动态范围增加,信噪比提升6dB+);提出"弱值衰减"概念使光学相位调制误差降低5倍+;挖掘输出关联性提升探测效率2-3个数量级;首次提出基于机器学习的噪声补偿算法;提出利用高阶模实现多参量测量
- **核心指标**:灵敏度达10⁻²⁴秒量级的时延测量;精度达3×10⁻⁶摄氏度的相对温度测量;精度达7.5×10⁻⁷弧度的非线性相移测量;温度测量精度极限比此前最好工作提高3个数量级
- **量子传感关联**:上海交大是量子传感基础研究的重要基地;弱值测量是量子精密测量的重要方向;该团队在提高量子传感灵敏度、动态范围、抗噪声能力方面有系统性贡献

#### 第五届量子科仪节暨量子精密测量产业应用峰会:国仪量子科创板过会,聚焦八大产业场景(2026-05-16)
- [第五届量子科仪节(腾讯新闻)](https://so.html5.qq.com/page/real/search_news?docid=70000021_8546a09838c07552) | [量子精密测量产业化走进深水区(腾讯新闻)](https://new.qq.com/rain/a/20260517A04WHK00) | 2026-05-16
- **核心信息**:国仪量子科创板IPO于5月11日过会;量子精密测量正从"能不能用"的技术验证阶段,迈入"和用户共创、跑通最后一公里"的阶段;聚焦电力电网、新能源、生命科学、地质勘测、半导体、石油、无损检测等八大产业场景
- **产品矩阵**:量子钻石系列、量子自旋磁力仪系列等多款成熟产品已在多个领域跑通产业化路径;心肌缺血早期诊断设备已完成数千例临床试验
- **产业趋势**:量子科技被列为六大未来产业之首;量子精密测量正从"单点突破"向"规模复制"跃迁;AI与量子传感融合成为重要趋势,已在半导体故障定位、地质矿产勘探等场景落地
- **量子传感关联**:国仪量子是国内量子传感产业化的龙头企业;量子科仪节是量子传感产业化的风向标会议
