...
#### Monarch Quantum × Oratomic战略合作：光子系统+中性原子架构，瞄准本十年末数万个量子比特（2026-04-28）
- [量子界, 2026-04-29](https://so.html5.qq.com/page/real/search_news?docid=70000021_95769f1e58162352) — 2026年4月28日，Monarch Quantum与Oratomic宣布战略合作
- **整合**：光子系统（Photonic system）+ 中性原子架构（Neutral atom architecture）
- **目标**：本十年末交付数万个物理量子比特、编码数千个错误更正逻辑量子比特的容错量子计算机
- **关联**：中性原子量子技术同时支撑量子计算与量子传感（原子磁力计、量子陀螺仪），此次合作为量子传感上游供应链注入新动能
