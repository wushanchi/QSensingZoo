...
*本次更新: Cerca Magnetics量子脑扫描仪380万英镑A轮融资/SEQUIN项目120万英镑探测地球+引力波/arXiv:2605.04136多参量量子传感理论突破/2026量子技术监测报告:QS国防进入应用阶段(2026-05-19中午)*
...
*QSensingZoo 维护中 | GitHub: wushanchi/QSensingZoo | 最后更新: 2026-05-19(追加)
---
...
*本次更新: Infleqtion量子射频Quantum Spectrum系统/桑迪亚量子导航"量子指南针"芯片突破/《2026年全球量子传感产业发展展望报告》核心数据/量子传感器检测粒子物理实验时空精度/多国联合研发/长沙量子原子干涉仪专利(2026-05-19中午)*

---

### 🆕 新增条目(2026-05-19中午 - 第七批)

#### Infleqtion公司推出"量子频谱"(Quantum Spectrum)量子射频传感系统,基于里德伯原子可在干扰环境中超越传统天线(2026-05-18)
- [新型量子射频系统可在干扰环境中超越传统天线(搜狐, 2026-05-18)](https://www.sohu.com/a/1024108059_121010025) | [Infleqtion官网](https://infleqtion.com/)
- **技术原理**:系统核心为里德伯原子——通过激光将电子激发到极高能态的原子,对无线电波等电磁场极为敏感;不依赖传统金属天线,而是利用激光监测入射无线电波如何扰动原子,将扰动转化为信号频率、方向和强度信息
- **三步量子传感流程**:①激光将原子激发到里德伯态②入射无线电波直接与原子相互作用③光学系统读出微小原子变化并转换为可用射频信息
- **核心优势**:单台接收器理论上可在极宽频率范围(从赫兹到太赫兹)内工作,无需多个天线系统;传统接收器在同时监测频谱多部分时往往力不从心,而基于原子的系统可使用单个孔径探测跨越广阔频率范围的信号——"天线失效之处,原子不会"
- **政府项目**:美国陆军研究实验室"稳健集成量子电磁接收器"(RIQER)项目(无GPS环境移动量子射频系统)、英国"量子测向"(QuDiFi)项目(量子信号来源方向确定)、澳大利亚"量子优化宽带里德伯原子"(QOBRA)接收器(量子传感+AI算法自动调谐)
- **应用场景**:无GPS导航、弹性通信、无人机探测、电子战、下代电信;已通过美、英、澳政府支持项目测试,正在构建原型并进行现场试验
- **发展趋势**:Infleqtion认为集成光子学可大幅缩小硬件尺寸,当前量子系统90%以上的尺寸和成本来自激光器和光子学
- **意义**:量子传感从"能测"迈向"能用"的标志性事件之一,基于原子的射频传感是量子技术中首个可能进入现实世界的重大商业化方向

#### 桑迪亚国家实验室量子导航"量子指南针"重大突破:硅基光电子微芯片原子干涉仪首次执行,无GPS导航里程碑(2026-04)
- [Science Advances 量子传感:迈向无GPS精确导航的里程碑(Latitude Design Automation)](https://www.latitudeda.com/document/753) | 原文:Sandia National Laboratories
- **核心突破**:科学家正在开发精度比当今导航级设备高1000倍的运动传感器,桑迪亚国家实验室首次使用硅基光电子微芯片组件执行原子干涉仪量子传感技术,是迈向"量子指南针"的关键一步
- **技术架构**:PIC激光系统(硅基光电子)包含三个主要功能模块:光调制(硅基光电子)、光放大(III-V族半导体)、光频率倍增(锂铌酸盐);通过混合/异质集成和光电共封装集成到单一PIC平台
- **微型化进展**:将大型真空泵替换为鳄梨大小的真空室;将通常分布在光学台上的多个组件整合到单个刚性装置;开发新型调制器芯片上激光系统
- **核心意义**:原子干涉仪在极长测量周期内展现前所未有的灵敏度,为无GPS环境下的精确定位提供全新手段;硅基光电子集成路线是量子传感器走向芯片级、小型化、工程化的关键支撑
- **应用前景**:军事导航、地质勘探、深空探测等领域

#### 《2026年全球量子传感产业发展展望报告》核心数据:2025年18.8亿美元→2035年50.7亿美元,CAGR10.42%(光子盒, 2026-03)
- [2026年全球量子传感产业发展展望报告(搜狐, 2026-03)](https://www.sohu.com/a/992499574_121755728) | iCV SA
- **产业成熟度**:2025年关键词为"可交付"——技术走出实验室进入工程验证、供应链整合与实际订单阶段;时频、磁场测量率先产业化,在国防授时、生物成像等场景替代经典方案;重力测量在资源勘探、地震监测找到刚需;电场、惯性等方向加速从样机向工程载荷演进
- **核心组件突破**:激光器、单光子探测器、原子气室等核心硬件性能提升且向量产化发展;外围保障系统定制化、辅助硬件集成化趋势明显;软件算法与AI融合大幅提升传感器环境鲁棒性
- **细分领域成熟度**:时频、磁场测量进入成长期;电场、旋转处于起步期;应力应变、温度尚处萌芽阶段
- **全球竞争格局**:美国发布12项量子政策以国防需求牵引形成完整产业梯队;中国将量子科技提升至国家未来产业首位,在磁传感、重力领域形成集群优势;欧盟推出量子战略并加强技术管控
- **资本趋势**:2025年全球融资额同比下降55.2%,资金向头部企业集中;中性原子技术路径成为投融资重点
- **下游应用**:军事国防仍是当前核心需求,民用化转型是产业实现规模效益的关键——需在成本、可靠性、易用性上接近或优于传统方案,嵌入工业自动化、智能驾驶等民用体系

#### 多国联合团队基于量子传感技术的超导微线单光子探测器(SMSPD),实现粒子物理实验时空高精度追踪(2026-04)
- [多国研究团队利用量子传感器提升粒子探测时空精度(腾讯新闻, 2025-04-28)](https://new.qq.com/rain/a/20250428A01QW800) | [加州理工学院官网](https://www.caltech.edu/)
- **研究团队**:美国加州理工学院、瑞士、委内瑞拉等多国联合研究团队,论文发表于《仪器仪表期刊》
- **技术基础**:基于量子传感技术的超导微线单光子探测器(SMSPD),可在粒子物理实验中实现时空同步高精度追踪
- **测试结果**:在美国费米实验室将量子传感器暴露在高能质子束、电子束和π介子束下,结果表明与传统探测器相比,该探测器在探测粒子时效率极高
- **意义**:量子传感技术在粒子物理实验这一极端环境中的应用拓展,证明了超导量子探测器在极高辐射环境下的可行性

#### 长沙量子测量产业技术研究院取得原子干涉仪偏置线圈磁场空间分布优化专利(2025-05)
- [长沙量子申请原子干涉仪相关专利(网易订阅, 2025-05)](https://www.163.com/dy/article/JUKQ82SN0519QIKK.html) | 公开号:CN119903662A
- **专利内容**:原子干涉仪偏置线圈磁场空间分布优化方法、测量方法及处理系统
- **技术方案**:获取偏置线圈与多组目标线圈电流对应的多组综合磁场空间分布曲线,包括获取偏置线圈在每组目标线圈电流下与多个原子团下落时间对应的多组拉曼谱数据集;根据拉曼谱数据得到综合磁场强度,再经压缩感知还原处理得到磁场空间分布曲线
- **应用价值**:可对偏置线圈产生的磁场进行更精确的测量及得到更优的控制曲线,对原子干涉仪的精度提升具有重要意义

#### 量子传感产业分析:2026年是量子传感商业化"跨越死亡之谷"关键年份(2026-03)
- [量子传感:工业感知的下一次跨越(腾讯新闻, 2026-03-04)](https://so.html5.qq.com/page/real/search_news?docid=70000021_08569a8149706452)
- **跨谷共识**:量子传感作为量子技术的"先遣部队",正以远超量子计算的商业化速度,率先跨越实验室与工业应用之间的"死亡之谷"
- **量化规模**:全行业总规模预计将由2025年的18.8亿美元增长至2035年的50.7亿美元,十年间产值年均复合增长率达10.42%
- **竞争焦点转变**:产业竞争从原理样机灵敏度比拼转向批量交付稳定性与成本控制;资本向具备工程化能力的成熟团队集中
- **技术成熟度矩阵**:时频(成长期)、磁场(成长期)、重力(成长期)、电场(起步期)、旋转(起步期)、应力应变(萌芽期)、温度(萌芽期)
